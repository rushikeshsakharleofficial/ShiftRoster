  ...
  useEffect(() => {
    ...
    orgApi.get().then(({ data }) => {
      ...
      if (logoUrl) {
        ...
        link.href = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='6' fill='%23d97706'/%3E%3Ctext x='16' y='22' font-family='system-ui,sans-serif' font-size='13' font-weight='800' text-anchor='middle' fill='%230d0a06'%3ESR%3C/text%3E%3C/svg%3E";
      }
    }).catch(() => {});
