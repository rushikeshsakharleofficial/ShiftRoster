              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <StatCard label="Total Employees" value={stats.total_employees} icon={Users}
                    color={{ bg: "bg-muted", icon: "text-muted-foreground" }} />
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <StatCard label="Leave Requests" value={stats.pending_leaves} icon={ClipboardList}
                    color={{ bg: "bg-amber-500/10", icon: "text-amber-500" }} sub="awaiting approval" />
                  ...
                  <StatCard label="My Tasks" value={pendingTasksCount} icon={Sparkles}
                    color={{ bg: "bg-muted", icon: "text-muted-foreground" }} sub="pending" />
                </div>
              </div>
            </>
          )}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { to: "/shifts", icon: CalendarDays, label: "Shift Calendar", sub: "View & manage shifts", color: { bg: "bg-primary/10", icon: "text-primary" }, testid: "quick-action-shifts" },
            { to: "/leave", icon: ClipboardList, label: "Leave Requests", sub: "Manage time off", color: { bg: "bg-primary/10", icon: "text-primary" }, testid: "quick-action-leave" },
            { to: "/attendance", icon: Clock, label: "Attendance", sub: "Clock in/out records", color: { bg: "bg-primary/10", icon: "text-primary" }, testid: "quick-action-attendance" },
